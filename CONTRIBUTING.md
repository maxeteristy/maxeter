Contributing to Maxeter Core
============================

The Maxeter Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/maxeteristy/maxeter/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Maxeter Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Maxeter
Network Protocol consensus changes.

Whether a pull request is merged into Maxeter Core rests with the project merge
...
Patches that change Maxeter consensus rules are considerably more involved than
...
Where a patch set proposes to change the Maxeter consensus, it must have been
...
The review process is normally fairly responsive on the Maxeter Core repository, however
...
The project leader is the release manager for each Maxeter Core release.
