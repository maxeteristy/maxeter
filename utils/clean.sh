...
rm -f src/config/maxeter-config.h
...
rm -rf test_bitcoin.coverage/ maxeter-gtest.coverage/ total.coverage/
...
clean_exe src/maxeter-cli
clean_exe src/maxeterd
clean_exe src/maxeter-gtest
clean_exe src/maxeter-tx
clean_exe src/test/test_maxeter
clean_exe src/test/test_maxeter_fuzzy
...
clean_dep . src/config/maxeter-config.h.in
