...
from test_framework.test_framework import MaxeterTestFramework
...
class LLMQChainLocksTest(MaxeterTestFramework):
    def set_test_params(self):
        self.set_maxeter_test_params(6, 5, fast_dip3_enforcement=True)
