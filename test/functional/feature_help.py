...
"""Verify that starting maxeterd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start maxeterd with -h for help text")
        ...
        self.log.info("Start maxeterd with -version for version information")
