...
//! Interface for the src/evo part of a maxeter node (maxeterd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a maxeter node (maxeterd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a maxeter node (maxeterd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a maxeter node (maxeterd process).
class Node
{
public:
    virtual ~Node() {}
