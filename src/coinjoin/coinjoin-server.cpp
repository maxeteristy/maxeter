...
/*
    ...
    allow endless transaction that would bloat Maxeter and make it unusable. To
...
bool CCoinJoinServer::IsInputScriptSigValid(const CTxIn& txin)
{
    ...
    if (nTxInIndex >= 0) { //might have to do this one input at a time?
        ...
        // TODO we're using amount=0 here but we should use the correct amount. This works because Maxeter ignores the amount while signing/verifying (only used in Bitcoin/Segwit)
