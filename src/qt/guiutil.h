...
/** Utility functions used by the Maxeter Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "maxeter:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load maxeter specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a maxeter specific theme is activated (light/dark).*/
