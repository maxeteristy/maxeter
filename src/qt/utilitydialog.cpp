    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  maxeter-qt [command-line options]                     \n";
...
All the Maxeter in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MAXE, 0.01 MAXE, 0.1 MAXE, 1 MAXE and 10 MAXE -- sort of like the paper money you use every day.</li> \
