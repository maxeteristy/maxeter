    ...
    tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Maxeter addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
        ui->newAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Maxeter addresses for receiving payments. It is recommended to use a new receiving address for each transaction."));
...
void AddressBookPage::on_showAddressQRCode_clicked()
{
    ...
    dialog->setInfo(tr("QR code"), "maxeter:"+strAddress, "", strAddress);
    dialog->show();
}
