...
#ifndef MAXETER_ARITH_UINT256_H
#define MAXETER_ARITH_UINT256_H
...
public:
     ...
     *
     * Maxeter only uses this "compact" format for encoding difficulty
