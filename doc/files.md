...
* maxeter.conf: contains configuration settings for maxeterd or maxeter-qt
* maxeterd.pid: stores the process id of maxeterd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by maxeterd or maxeter-qt
