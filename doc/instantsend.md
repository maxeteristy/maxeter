...
This mechanism has been integrated into Bitcore-Node-Maxeter which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/maxeteristy/insight-api-maxeter#web-socket-api](https://github.com/maxeteristy/insight-api-maxeter#web-socket-api)
* API: [https://github.com/maxeteristy/insight-api-maxeter#instantsend-transactions](https://github.com/maxeteristy/insight-api-maxeter#instantsend-transactions)
