# Contents
This directory contains tools to automatically get data about the memory consumption by some objects in maxeterd process with the help of GDB debugger.

## maxeter_dbg.sh
This shell script attaches GDB to the running maxeterd process (should be built with debug info), executes debug.gdb script and detaches.
By default it uses testnet settings, see script comments to attach it to mainnet maxeterd.
